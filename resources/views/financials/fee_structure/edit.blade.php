               ...
               <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="flex flex-col gap-2">
                     ...
                     <select name="grade_level_id"
                        ...
                        <option value="{{ $gradeLevel->id }}" {{ old('grade_level_id', $feeStructure->grade_level_id) ==
                  ...
                  <div class="flex flex-col gap-2">
                     ...
                     <select name="program_type_id"
                        ...
                        <option value="{{ $programType->id }}" {{ old('program_type_id', $feeStructure->program_type_id)
                           == $programType->id ? 'selected' : '' }}>
