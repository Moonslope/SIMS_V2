...
<div class="p-5">
   <!-- Page Header -->
   <div class="my-8">
      <h1 class="text-4xl font-bold text-blue-600 mb-2 text-center">Class Schedule</h1>
   ...
   <div class="card bg-base-100 shadow-md mb-6 rounded-lg">
      <div class="card-body">
         <h3 class="card-title text-blue-600 mb-4">

            Student Information
         </h3>
         <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="flex items-start gap-2">
               <i class="fi fi-sr-user text-blue-600 mt-1"></i>
               <div>
            ...
            <div class="flex items-start gap-2">
               <i class="fi fi-sr-calendar text-blue-600 mt-1"></i>
               <div>
            ...
            <div class="flex items-start gap-2">
               <i class="fi fi-sr-book text-blue-600 mt-1"></i>
               <div>
            ...
            <div class="flex items-start gap-2">
               <i class="fi fi-sr-diploma text-blue-600 mt-1"></i>
               <div>
            ...
            <div class="flex items-start gap-2">
               <i class="fi fi-sr-users text-blue-600 mt-1"></i>
               <div>
      ...
      <div class="card-body">
         ...
         <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div class="flex items-center gap-2 p-3 bg-base-200 rounded-lg">
               <i class="fi fi-sr-book text-blue-600"></i>
