...
<div class="p-5">
   <!-- Page Header -->
   <div class="my-8">
      <h1 class="text-4xl font-bold text-[#0F00CD] mb-2 text-center">Select School Year</h1>
   ...
   <div role="alert" class="alert bg-[#d1ecf1] rounded-lg mb-6">
      <i class="fi fi-sr-info text-[#0F00CD]"></i>
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
      ...
      <a href="{{ route('students.switchSchoolYear', $year->id) }}"
         ...
         <div class="card-body text-center">
            ...
            <!-- Year Name -->
            <h2 class="card-title text-[#0F00CD] justify-center text-2xl font-bold mb-2">
               {{ $year->year_name }}
            </h2>
