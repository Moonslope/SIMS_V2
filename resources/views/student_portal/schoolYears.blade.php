...
<div class="p-5">
   <!-- Page Header -->
   <div class="my-8">
      <h1 class="text-4xl font-bold text-primary mb-2 text-center">Select School Year</h1>
   ...
   <div role="alert" class="alert bg-[#d1ecf1] rounded-lg mb-6">
      <i class="fi fi-sr-info text-primary"></i>
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
      ...
      <a href="{{ route('students.switchSchoolYear', $year->id) }}"
         class="card bg-base-100 shadow-md rounded-lg hover:shadow-xl transition-all duration-200 cursor-pointer hover:scale-105 group border-2 border-transparent hover:border-primary">
         <div class="card-body text-center">

            <!-- Year Name -->
            <h2 class="card-title text-primary justify-center text-2xl font-bold mb-2">
               {{ $year->year_name }}
            </h2>
            ...
            <div class="card-actions justify-center">
               <button class="btn btn-sm bg-primary text-white border-none group-hover:bg-opacity-90 rounded-lg">
                  View Details
               </button>
            </div>
         </div>
