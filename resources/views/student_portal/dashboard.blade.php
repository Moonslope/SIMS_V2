...
<div class="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div>
         ...
         <p class="text-sm text-gray-600">You are viewing records for a previous school year.
            <a href="{{ route('students.schoolYears') }}"
               class="text-primary font-bold underline hover:text-blue-800">Switch to Current Year</a>
         </p>
      </div>
   </div>
   @endif
   ...
   <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-6 relative overflow-hidden">
      ...
      <div class="flex flex-col md:flex-row items-center md:items-start gap-6 mt-2">
         <div class="shrink-0">
            <div class="bg-primary text-white flex justify-center items-center rounded-full w-20 h-20 shadow-lg">
         ...
         <div class="flex-1 text-center md:text-left">
            ...
            <div class="flex flex-wrap gap-3 justify-center md:justify-start">
               <span
                  class="inline-flex items-center px-3 py-1 rounded-full text-xs md:text-sm  font-medium bg-[#F0F4FF] text-primary border border-blue-100">
   ...
   <div class="bg-[#F0F4FF] border-l-4 border-primary p-4 rounded-r-lg flex items-center gap-3">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary shrink-0" fill="none" viewBox="0 0 24 24"
         stroke="currentColor">
         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
   ...
   <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 transition hover:shadow-md">
         ...
         <p class="text-2xl font-bold text-primary">₱{{ number_format($totalAssessment, 2) }}</p>
      </div>
      ...
      <div class="bg-white p-6 rounded-xl shadow-xs border border-gray-100 transition hover:shadow-md">
         ...
         <div class="flex items-center gap-2">
            <p class="text-2xl font-bold text-primary">₱{{ number_format($totalPaid, 2) }}</p>
      ...
      <div
         ...
         <div class="relative z-10">
            ...
            <p class="text-2xl font-bold text-primary">₱{{ number_format($currentBalance, 2) }}</p>
   ...
   <div class="block lg:hidden pt-4 border-t border-gray-100">
      ...
      <div class="grid grid-cols-2 gap-3">
         <a href="{{ route('students.paymentHistory') }}"
            class="flex flex-col items-center justify-center p-4 bg-[#F0F4FF] text-primary rounded-lg border border-blue-100 active:scale-95 transition">
