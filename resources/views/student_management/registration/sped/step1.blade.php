         ...
         <div class="card-body p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
               <div class="form-control w-full">
                  ...
                  <input name="type_of_disability" type="text"
                     class="input input-bordered rounded-lg w-full focus:outline-none focus:border-blue-600 @error('type_of_disability') input-error @enderror"
            ...
            <div class="form-control w-full">
               ...
               <textarea name="cause_of_disability" rows="4"
                  class="textarea textarea-bordered rounded-lg w-full focus:outline-none focus:border-blue-600 @error('cause_of_disability') textarea-error @enderror"
