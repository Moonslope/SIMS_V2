...
@section('title', 'Create Program Type')
@section('content')
<div class="px-5 py-3 flex flex-col gap-4">
   <div class="breadcrumbs text-xs">
      <ul>
         <li><a href="{{route('program-types.index')}}">Academics</a></li>
         ...
         <div class="flex flex-col gap-10">
            <div class="flex flex-col gap-8">
               <div class="flex flex-col gap-2">
                  ...
                  <input name="program_name" type="text" placeholder="e.g., Regular, SPED"
               ...
               <div class="flex flex-col gap-2">
                  ...
                  <textarea name="description" rows="4"
                     ...
                     placeholder="Write a short description about this program type...">{{ old('description') }}</textarea>
                  @error('description')
                  <div class="text-error text-sm mt-1">{{ $message }}</div>
                  @enderror
               </div>
               ...
               <div class="flex items-center gap-2">
                  ...
                  <input type="checkbox" name="is_active" value="1"
                     ...
                     isset($programType) ? $programType->is_active : false) ? 'checked' : '' }}
                  />
