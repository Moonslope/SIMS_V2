...
<div class="px-5 py-3 flex flex-col gap-4">
   <div class="breadcrumbs text-xs">
      <ul>
         <li><a href="{{route('teachers.index')}}">Academics</a></li>
         <li><a>Teachers</a></li>
   ...
   <div class="rounded-lg bg-blue-600 shadow-lg">
      <h1 class="text-[24px] font-semibold text-base-300 ms-3 p-2">Add New Teacher</h1>
   </div>
            ...
            <div class="flex flex-col gap-8">
               ...
               <div class="flex items-center gap-2">
                  ...
                  <input type="checkbox" name="is_active" value="1"
                     ...
                     isset($teacher) ? $teacher->is_active : false) ? 'checked' : '' }}
                  />
