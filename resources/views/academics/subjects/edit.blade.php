...
<div class="px-5 py-3 flex flex-col gap-4">
   ...
   <div class="rounded-lg bg-primary shadow-lg">
      <h1 class="text-[24px] font-semibold text-base-300 ms-3 p-2">Edit Subject</h1>
   </div>
            ...
            <div class="flex flex-col gap-8">
               <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="flex flex-col gap-2">
                     <label for="subject_name" class="text-sm font-medium">Subject Name <span
                           class="text-error">*</span></label>
                     <input name="subject_name" type="text" placeholder="Type here"
                        class="input w-full input-bordered rounded-lg @error('subject_name') input-error @enderror"
                  ...
                  <div class="flex flex-col gap-2">
                     ...
                     <select name="grade_level_id"
                        ...
                        <option value="{{ $gradeLevel->id }}" {{ old('grade_level_id', $subject->grade_level_id) ==
                           $gradeLevel->id ? 'selected' : '' }}>
               ...
               <div class="flex flex-col gap-2">
                  ...
                  <textarea name="description"
                     ...
                     placeholder="Write a short description here (Optional)">{{ old('description', $subject->description) }}</textarea>
                  @error('description')
                  <div class="text-error text-sm mt-1">{{ $message }}</div>
                  @enderror
               </div>
