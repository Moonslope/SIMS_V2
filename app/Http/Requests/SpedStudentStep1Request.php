...
class SpedStudentStep1Request extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cause_of_disability' => 'nullable|string|max:500',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'type_of_disability.required' => 'The type of disability is required.',
            'type_of_disability.string' => 'The type of disability must be text.',
            'type_of_disability.max' => 'The type of disability must not exceed 255 characters.',

            'date_of_diagnosis.required' => 'The date of diagnosis is required.',
            'date_of_diagnosis.date' => 'The date of diagnosis must be a valid date.',

            'cause_of_disability.string' => 'The cause of disability must be text.',
            'cause_of_disability.max' => 'The cause of disability must not exceed 500 characters.',
        ];
    }
}
